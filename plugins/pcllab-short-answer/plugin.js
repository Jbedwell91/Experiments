 ...
 * @param {string} questionString - Optional string to use as a single question. Will not use url or label questions
 * if specified.
...
jsPsych.plugins["pcllab-short-answer"] = (function() {
  ...
  plugin.trial = function(display_element, trial) {
    ...
    if (!trial.questionString && !jsPsych.userInfo.shortAnswerQuestions) {
    ...
    function show() {
      if (trial.questionString) {
        questions = [{
          "question": trial.questionString
        }];
      } else if (trial.label) {
    ...
    function showQuestion(question) {
      ...
      function writeData() {
        ...
        if (trial.questionString) {
          data.questionString = trial.questionString;
        } else {
