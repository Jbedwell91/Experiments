  ...
  plugin.trial = function (display_element, trial) {
    ...
    function setup() {
        ...
        function appendWords(words) {
            ...
            words.forEach(function(word) {
                ...
                if (trial.stopwords.indexOf(word) > 0) {
                    ...
                    var element = '<span class="pcllab-identify-keywords-word" wordname={{word}}>{{word}}</span>'.
        ...
        function select() {
            ...
            var kwords = $('span[wordname='+word+']');
            $('span[wordname='+word+']').addClass('pcllab-identify-keywords-word-selected');
        ...
        function deselect() {
            var word = $(this).html().trim()
            $('span[wordname='+word+']').removeClass('pcllab-identify-keywords-word-selected');
            $(this).off("click");
            $(this).click(select);
        ...
        function render_wordbank() {
            ...
            word_list.forEach(function(w) {
                word = w;
                wordbank.append('<p id="bankword" class="pcllab-identify-keywords-word">'+w+"</p>");
                $('[id="bankword"]').click(deselect);
            });
