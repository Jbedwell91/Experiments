 ...
 * @param {string=Select} button_highlight_text - Text that will appear on the 'select' button.
 * @author Anirudh Chellani, Garrick Buckley
 */

jsPsych.plugins["pcllab-highlight-text"] = (function () {
    ...
    plugin.trial = function (display_element, trial) {
        ...
        trial.button_highlight_text = trial.button_highlight_text || "Select";
        ...
        function loadQuestion() {
            ...
            question.append("<textarea readonly rows=5 style='overflow-y:scroll;'>", {
                type: "text"
            });
            ...
            var selectButton = $('<button>', {
              id: "select-button",
              class: "btn btn-primary btn-lg",
              text: trial.button_highlight_text
            });
            buttonContainer.append(button.on('click', function() {
                nextQuestion();
            }));
            buttonContainer.append(selectButton.on('click', function() {
                setSelection();
            }));
            ...
            $(".pcllab-sat-textbox").mousedown(onInput).focus();
        }
        ...
        function setSelection(){
          ...
          $(".pcllab-sat-question textarea").val(selectText);
        }
        function writeData() {
            var questionData = {};
